...
class RecAnalyst {
    ...
    protected function analyzeheaderStream() {
        ...
        switch ($version) {
            ...
            case RecAnalystConst::VER_95:
                $this->gameInfo->_gameVersion = GameVersion::AOC21;
                break;
            default:
                        ...
                        if ($this->_isMgl) {
                            ...
                            switch ($od_type) {
                                case 0x03:
                                    ...
                                    break;
                                case 0x04:
                                    if ($this->gameInfo->_gameVersion == GameVersion::AOC) {
    ...
    protected function postAnalyze() {
        ...
        if ($this->gameInfo->_gameVersion > GameVersion::AOC10C) {
